...
```{r fig-dimerization-sim, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Thymine Photodimerization Reaction Set Simulation \\label{fig:dimerization-sim}"}
...
Due to the stochastic nature of molecular reactions, this algorithm reflects fluctuations of photodimerization as it models the probabilistic process of each reaction (Figure \ref{fig:dimerization-sim}).
