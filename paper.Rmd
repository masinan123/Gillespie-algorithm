...
Therefore, this simulation involves four species: pyrimidine monomers Thymine 1 (\( T_1 \)), Thymine 2 (\( T_2 \)), and dimer photoproducts \( CPD \) and \( 64PP \); and two reactions channels: \( c_1 \) and \( c_2 \).
\[
